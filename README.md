...
<body>
	...
	<main>
		<section>
			...
			<img src="Assets/Screenshot (507).png" alt="Home Page Screenshot" width ="1200" height ="600"></a>
			<button class="GFG" onclick="window.location.href = 'https://ide.geeksforgeeks.org';">
        Click Here
    </button>
			<a href="https://viswanath-621.github.io/CodeClause-Projects/"><button id ="btn"> View Home Page</button>  </a>
		</section>
		<section>
